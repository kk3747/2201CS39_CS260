...
$sc_perce_prev1 = "";
$sc_div_prev1 = "";
$sql = "SELECT * FROM `phd_info` WHERE `APP_NO` = '$app_no';";
...
$sql = "SELECT * FROM `pg_info` WHERE `APP_NO` = '$app_no';";
$result = $conn->query($sql); 
if( mysqli_num_rows($result) == 1 ) 
{
    $row = $result->fetch_assoc();
...
$sql = "SELECT * FROM `ug_info` WHERE `APP_NO` = '$app_no';";
$result = $conn->query($sql);
if( mysqli_num_rows($result)  == 1 ) 
{
    $row = $result->fetch_assoc();
...
$sql = "SELECT * FROM `school_info` WHERE `APP_NO` ='$app_no' AND `standard` = '12th';";
$result = $conn->query($sql);
if( mysqli_num_rows($result) == 1 ) 
{
    $row = $result->fetch_assoc();
...
$sql = "SELECT * FROM `school_info` WHERE `APP_NO` = '$app_no' AND `standard` = '10th';";
$result = $conn->query($sql);
if( mysqli_num_rows($result) == 1 ) 
{
    $row = $result->fetch_assoc();       
...
$sql_additional = "SELECT * FROM `more_qual_details` WHERE APP_NO = ?";
...
{
    $sql = "INSERT INTO `applicationForm`.`phd_info` (`APP_NO` , `university`, `department`, `Name_of_PhD_Supervisor`, `Year_of_Joining`, `Date_of_Successful_Thesis_Defence`, `Date_of_Award` , `Title_of_PhD_Thesis` ) VALUES ('$app_no' , '$university', '$department', '$Name_of_PhD_Supervisor', '$Year_of_Joining', '$Date_of_Successful_Thesis_Defence', '$Date_of_Award' , '$Title_of_PhD_Thesis');";
    ...
    else 
    {
        ...
        {
            $sql =  "INSERT INTO `pg_info` (`APP_NO` , `degree` , `university` , `stream` , `Year_of_Joining` , `Year_of_Completion` , `duration` , `cgpa` , `division` )
        ...
        {
            $sql =  "INSERT INTO `ug_info` (`APP_NO` , `degree` , `university` , `stream` , `yoj` , `yoc` , `duration` , `percentage` , `division` )
        ...
        if( mysqli_num_rows($result) == 1 ) {
          ...
          $sql = "INSERT INTO `school_info` ( `standard` , `school` , `year_of_passing` , `percentage/grade` , `division` , `APP_NO` ) VALUES (  '$standard' , '$school' , '$year_of_passing' , '$percentage' , '$division' , '$app_no' );";
        ...
        if (isset($_POST['submit']) ) {
                ...
                $sql = "DELETE FROM `more_qual_details` WHERE `APP_NO` = '$app_no'";
                $conn->query($sql);
                ...
                for( $i = 0 ; $i < count($adi_add_degree); $i++ ) {
                    ...
                    $sql = "INSERT INTO `more_qual_details` ( `APP_NO` , `degree` , `university` , `branch` , `yoj` , `yoc` , `duration` , `percentage` , `division` ) VALUES ( '$app_no' , '$degree' , '$college' , '$subjects' , '$yoj' , '$yog' , '$duration' , '$perce' , '$rank' );";
