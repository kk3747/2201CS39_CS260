...
if (isset($_POST['firstname'])) 
{
    ...
    else 
    {
        ...
        $query = "SELECT * FROM `applicationForm`.`registered_data` WHERE EMAIL = '$email'";
        ...
        {
            $sql = "INSERT INTO `applicationForm`.`registered_data` (`FIRSTNAME`, `LASTNAME`, `EMAIL`, `CATEGORY`, `PASSWORD`, `APP_DATE`) VALUES ('$first_name', '$last_name', '$email', '$category', '$password', current_timestamp());";
