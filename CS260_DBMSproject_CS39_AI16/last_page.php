...
$html = '   
$sql = "Select * from apply_info where APP_NO = '$app_no'";
...
$sql = "Select * from personal_info where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$sql = "Select * from school_info where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$html = '<table class = "tab" >';
$sql = "Select * from more_qual_details where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$html = '<table class = "tab">';
$sql = "Select * from curr_job where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$html = '<table class = "tab">';
$sql = "Select * from emp_hist_data where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$html = '<table class = "tab">';
$sql = "Select * from teaching_ex where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$html = '<table class = "tab">';
$sql = "Select * from research_exp where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$html = '<table class = "tab">';
$sql = "Select * from exp_of_industry where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$html = '<table class = "tab">';
$sql = "Select * from main_skill where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$sql = "Select * from training_experience where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$sql = "Select * from award_details where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$sql = "Select * from proj_info where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$sql = "Select * from consult where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$sql = "Select * from doc_details where APP_NO = '$app_no'";
$query = mysqli_query($conn, $sql);
...
$sql = "Select signature from doc_details where APP_NO = '$app_no';";
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($query);
