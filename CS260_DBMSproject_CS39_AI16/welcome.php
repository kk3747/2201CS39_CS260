<?php
    ...
    $dept = $_POST['dept'];
    $post = $_POST['post'];       
    $sql = "INSERT INTO apply_info (AdvertisementNumber, 	DateOfApplication, APP_NO , 	PostAppliedFor , 	DepartmentSchool ) 
        VALUES (?, ?, ?, ?, ? )
        ...
        $sql = "INSERT INTO personal_info (APP_NO, FirstName, MiddleName , LastName , 	Nationality, DOB	, 
        ...
        $stmt1->bind_param("isssssssssssssssssss", $app_no,  $first_name_welcome , $middle_name_welcome , $last_name_welcome ,
          $nationality, $dob  , $gender , $marital_status , $category , $id_proof , $father_name, $img1 , $img2 , $cadd         , $padd,$mobile, $email , $email_2 ,$mobile_2 ,  $landline) ;
        $stmt1->execute();
        $stmt1->close();
