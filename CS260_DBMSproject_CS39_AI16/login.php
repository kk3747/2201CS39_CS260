<?php 
    if( $_SERVER['REQUEST_METHOD'] == 'POST' ) 
    {
        ...
        if( !$conn )
        {
            die("You are failed to Connect : " . mysqli_connect_error());
        }
        else 
        {
            echo "You are successfully connected<br/>";
        }
        $sql = "SELECT * FROM `registered_data` WHERE EMAIL = '$email' AND PASSWORD = '$password'";
        ...
        {
            echo "This is not registered email";
        }
    }
